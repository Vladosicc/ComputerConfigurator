...
{
    public class SsdCitilinkController : Controller
    {
        readonly IProductCitilinkManager _productCitilinkManager;

        public SsdCitilinkController(IProductCitilinkManager manager)
        {
        ...
        {
            var products = await _productCitilinkManager.GetEnumerableAsync(Models.PartCode.Ssd);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var productCitilink = await _productCitilinkManager.FindAsync(Models.PartCode.Ssd, id.Value);
