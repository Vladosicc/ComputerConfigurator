...
{
    public class CasingCitilinkController : Controller
    {
        readonly IProductCitilinkManager _productCitilinkManager;

        public CasingCitilinkController(IProductCitilinkManager manager)
        {
        ...
        {
            var products = await _productCitilinkManager.GetEnumerableAsync(Models.PartCode.Casing);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var productCitilink = await _productCitilinkManager.FindAsync(Models.PartCode.Casing, id.Value);
