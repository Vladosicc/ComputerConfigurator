...
{
    public class HddCitilinkController : Controller
    {
        readonly IProductCitilinkManager _productCitilinkManager;

        public HddCitilinkController(IProductCitilinkManager manager)
        {
        ...
        {
            var products = await _productCitilinkManager.GetEnumerableAsync(Models.PartCode.Hdd);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var productCitilink = await _productCitilinkManager.FindAsync(Models.PartCode.Hdd, id.Value);
